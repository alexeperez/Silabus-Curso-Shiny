...
Generalmente implementar un algoritmo en R tiene la finalidad de disminiur el tiempo de ejecución de una determinada tarea que realizarala manualmente conlleva un tiempo considerable. Un programador siempre debe tener en mente que sus implementaciones serán usadas por varios usuarios, entre ellos, aquellos que no poseen conocimientos sobre el lenguaje R, es por esta razón que es necesario desarrollar interfaces gráficas mediante las cuales el usuario pueda ejecutar el algoritmo a través de botones y controladores (widgets).\newline

El curso Interfaces de Usuario con Shiny tiene como finalidad proveer al estudiante de un conjunto de herramientas necesarias para la generación de una interfaz gráfica de usuario mediante la utilización del R-paquete Shiny.\newline
...
\item{Bienvenido a Shiny}
\begin{enumerate}
\item[1.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}
...
\item{Añadir widgets de control}
\begin{enumerate}
\item[3.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}

\item{Pantalla de salida reactiva}
\begin{enumerate}
\item[4.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}

\item{Uso R scripts y datos}
\begin{enumerate}
\item[5.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}

\item{Utilizar expresiones reactivas}
\begin{enumerate}
\item[6.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}

\item{Comparte tus aplicaciones}
\begin{enumerate}
\item[7.1]{Generación el primer gráfico ggplot2.}
\end{enumerate}
